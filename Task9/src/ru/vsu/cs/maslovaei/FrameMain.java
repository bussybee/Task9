...
//tableOutput.setEnabled(false);
        ...
        menuLookAndFeel.setText("Number 13");
        ...
        buttonTransform.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                try {
                    ...
                    JTableUtils.writeArrayToJTable(tableOutput, ArrayUtils.intListToArray(TransformList.transformList(ArrayUtils.intArrayToList(arr))));
                } catch (Exception e) {
                    SwingUtils.showErrorMessageBox(e);
                }
            }
