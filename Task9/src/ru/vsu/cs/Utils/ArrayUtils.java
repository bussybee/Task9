...
public class ArrayUtils {
    ...
    */
    ...
    public static List<Integer> readAndCheckFileForNull(String fileName) {
        int[] array = readIntArrayFromFile(fileName);
    ...
    public static void writeListToFile(String fileName, List<Integer> list) throws FileNotFoundException {
        writeArrayToFile(fileName, intListToArray(list));
    }
}
