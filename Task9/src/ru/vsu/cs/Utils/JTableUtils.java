...
import ru.vsu.cs.maslovaei.Utils.ArrayUtils;
...
public class JTableUtils {
    ...
    public static int[][] readIntMatrixFromJTable(JTable table) throws ParseException {
        try {
            ...
            return (int[][]) Arrays.stream(matrix).map(ru.vsu.cs.maslovaei.Utils.ArrayUtils::toPrimitive).toArray((n) -> new int[n][]);
        } catch (JTableUtilsException impossible) {
        }
        return null;
    }
    ...
    public static int[] readIntArrayFromJTable(JTable table) throws ParseException {
        try {
            return ru.vsu.cs.maslovaei.Utils.ArrayUtils.toPrimitive(readArrayFromJTable(table, Integer.class, Integer::parseInt, false, 0));
        } catch (JTableUtilsException impossible) {
        }
        return null;
    }
    ...
    public static double[][] readDoubleMatrixFromJTable(JTable table) throws ParseException {
        try {
            ...
            return (double[][]) Arrays.stream(matrix).map(ru.vsu.cs.maslovaei.Utils.ArrayUtils::toPrimitive).toArray((n) -> new double[n][]);
        } catch (JTableUtilsException impossible) {
        }
        return null;
    }
